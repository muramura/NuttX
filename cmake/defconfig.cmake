...
execute_process(COMMAND make --no-print-directory --silent TOPDIR=${NUTTX_DIR} APPDIR=${NUTTX_APPS_DIR} Kconfig
	OUTPUT_FILE ${CMAKE_BINARY_DIR}/kconfig_apps.log ERROR_FILE ${CMAKE_BINARY_DIR}/kconfig_apps.log
	WORKING_DIRECTORY ${NUTTX_APPS_DIR}
)

execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different dummy_kconfig Kconfig
...
execute_process(COMMAND kconfig-conf --olddefconfig Kconfig WORKING_DIRECTORY ${NUTTX_DIR}
		OUTPUT_FILE ${CMAKE_BINARY_DIR}/kconfig.log ERROR_FILE ${CMAKE_BINARY_DIR}/kconfig.log
)
execute_process(COMMAND kconfig-tweak --set-str CONFIG_APPS_DIR "${NUTTX_APPS_DIR}" WORKING_DIRECTORY ${NUTTX_DIR})
